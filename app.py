...
# model = torch.hub.load('yolov5', 'custom', path='C:/Users/a0103/OneDrive/바탕 화면/idcard/yolov5/runs/train/exp/weights/best.pt', source='local')
...
#             text = pytesseract.image_to_string(cropped_img_thresh, lang='kor+eng', config=custom_config).strip()

#             if class_name == 'name':
#                 text = re.sub(r'[^가-힣\s]', '', text)
#             elif class_name == 'id_number':
#                 text = re.sub(r'[^0-9-]', '', text)
#             elif class_name == 'issue_date':
#                 text = re.sub(r'[^0-9.]', '', text)
